...
import { UI_SETTINGS_DISPLAY } from '../ui.config';
                        ...
                        <div className="w-full md:w-1/3">
                            ...
                            <div>
                                ...
                                <ul className="list-disc pl-4">
                                    <li>Supported images: <br />{UI_SETTINGS_DISPLAY.supportedExtensions
                                        .map((ext, i) => <span key={i}>
                                            {i !== 0 ? ', ' : ''}<em>{ext}</em>
                                        </span>)}
                                    </li>
                                    <li>Images cannot exceed {UI_SETTINGS_DISPLAY.maxFileSize}</li>
                                    <li>Sessions cannot upload more than {UI_SETTINGS_DISPLAY.maxTotalSize} of files at a time.</li>
                                </ul>
                            </div>
                        </div>
                        <div className="w-full md:w-1/3">
                        ...
                        <div className="w-full md:w-1/3">
                            ...
                            <div>
                                ...
                                <ul className="list-disc pl-4">
                                    ...
                                    <li>Temporary server copies used during processing are permanently deleted after about {UI_SETTINGS_DISPLAY.uploadedFileLifespan}.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
